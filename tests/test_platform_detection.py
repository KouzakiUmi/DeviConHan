...
class TestPlatformDetection(unittest.TestCase):
    def test_find_game_in_steam_reuses_supplied_search_paths_for_appid_lookup(self):
        ...
        with (
            patch("utils.platform.find_game_by_appid", return_value=r"D:\Games\Target") as by_appid,
    ...
    def test_find_game_in_steam_reuses_supplied_search_paths_for_name_scan(self):
        ...
        with (
            patch("utils.platform.find_game_by_appid", return_value=None) as by_appid,
