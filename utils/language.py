...
LANG_DICT: Dict[str, Dict[str, str]] = {
    "cn": {
        ...
        # Auto Patcher
        "lbl_patch_info": "选择内置或自定义汉化补丁，然后点击安装。",
        ...
        "btn_to_tools": "🛠 高级工具箱",
        "msg_restore_patch_confirm": "确定要卸载汉化补丁并还原原版游戏文件吗？\n\n请先关闭游戏。还原将使用安装补丁时创建的原始 app.asar 备份；存档不会受到影响。",
        "msg_patch_restore_success": "✅ 汉化补丁已卸载，原版游戏文件已还原。\n\n存档未被修改。",
        ...
        "log_patch_extracting_zip": "解压 Patch.zip...",
        "log_patch_zip_root_detected": "检测到补丁 ZIP 包装目录，将自动移除层级：{root}",
        "log_patch_zip_root_direct": "补丁 ZIP 已位于正确的 ASAR 根目录层级。",
        "log_patch_zip_extracted": "Patch.zip 解压完成。",
        "err_patch_zip_layout": "无法安全判断 Patch.zip 的实际补丁根目录：{error}",
        "log_patch_copying_dir": "复制 Patch 目录...",
    ...
    "en": {
        ...
        # Auto Patcher
        "lbl_patch_info": "Choose the bundled or a custom translation patch, then install it.",
        ...
        "msg_restore_patch_confirm": "Remove the translation patch and restore the original game files?\n\nClose the game first. This uses the original app.asar backup created during patch installation; save data is not affected.",
        "msg_patch_restore_success": "✅ The translation patch was removed and the original game files were restored.\n\nSave data was not modified.",
        ...
        "log_patch_extracting_zip": "Extracting Patch.zip...",
        ...
        "log_patch_zip_extracted": "Patch.zip extracted successfully.",
        "err_patch_zip_layout": "Cannot safely determine the Patch.zip payload root: {error}",
        "log_patch_copying_dir": "Copying Patch directory...",
    ...
    "jp": {
        ...
        # Auto Patcher
        "lbl_patch_info": "内蔵またはカスタム翻訳パッチを選択して、インストールしてください。",
        ...
        "msg_restore_patch_confirm": "翻訳パッチを削除して、オリジナルのゲームファイルに戻しますか？\n\n先にゲームを終了してください。パッチのインストール時に作成された app.asar のバックアップを使用します。セーブデータには影響しません。",
        "msg_patch_restore_success": "✅ 翻訳パッチを削除し、オリジナルのゲームファイルに戻しました。\n\nセーブデータは変更されていません。",
        ...
        "log_patch_extracting_zip": "Patch.zip を展開中...",
        ...
        "log_patch_zip_extracted": "Patch.zip の展開が完了しました。",
        "err_patch_zip_layout": "Patch.zip の実際のパッチルートを安全に判定できません：{error}",
        "log_patch_copying_dir": "Patch ディレクトリをコピー中...",
